...
async def test_step_breed_age_recognises_cat_breed_as_non_dog(monkeypatch):
    ...
    parse_mock = AsyncMock(return_value={"breed": "domestic short hair", "species": "cat", "age_years": None, "age_text": None, "dob": None})
    monkeypatch.setattr(onboarding, "_parse_breed_age", parse_mock)
...
async def test_step_breed_age_recognises_british_shorthair_as_non_dog(monkeypatch):
    ...
    parse_mock = AsyncMock(return_value={"breed": "british shorthair", "species": "cat", "age_years": None, "age_text": None, "dob": None})
    monkeypatch.setattr(onboarding, "_parse_breed_age", parse_mock)
