...
async def _call_openai_with_tools(messages: list) -> object:
    ...
    """
    from app.services.whatsapp.onboarding import _get_openai_onboarding_client
...
async def _finalize_agentic_order(
    ...
    """
    from app.services.whatsapp.order_service import _notify_admin_whatsapp, _send_post_order_recommendations
