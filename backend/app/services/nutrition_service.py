...
COMBINED_MEAL_SYSTEM_PROMPT = (
    ...
    "- detail: ONE line only — max 25 words. Structure: why this nutrient matters for THIS pet (1 clause) + a specific natural source or supplement example (1 clause).\n"
    "  Tone must match severity:\n"
    "  high → urgent language: \"Critical for X — must add Y\" or \"Deficient and essential for Z — supplement with Y now.\"\n"
    "  medium → softer language: \"Beneficial for X — consider adding Y\" or \"Can help with Z — try Y.\"\n"
    ...
    "- top_improvements must span calories, macros, AND micros — do not pull from one category only.\n"
    "- detail in top_improvements must be ONE line, max 25 words: why it matters for this pet + a natural source or supplement example.\n\n"
    "-----------------------------------\n"
    "FAIL-SAFE\n"
    "-----------------------------------\n\n"
