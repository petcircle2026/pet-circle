...
EXTRACTION_SYSTEM_PROMPT = (
    ...
    '    - "condition_name": string --- the CLEAN clinical name of a diagnosed DISEASE, DISORDER, or SYNDROME only '
    '(e.g. "Hip Dysplasia", "Diabetes Mellitus", "Otitis Externa", "Skin Allergy", "Urinary Incontinence"). '
    'NEVER append cause qualifiers, triggers, or context to condition_name --- strip phrases like '
    '"(post spay)", "(post surgery)", "(secondary to X)", "(due to Y)", "(stress-related)" from the name. '
    'Those belong in the "diagnosis" field instead. '
    ...
    '    - "diagnosis": string or null --- brief diagnosis description. Include any cause qualifiers or context '
    'stripped from condition_name here (e.g. "Post spay", "Secondary to allergies", "Stress-induced").\n'
